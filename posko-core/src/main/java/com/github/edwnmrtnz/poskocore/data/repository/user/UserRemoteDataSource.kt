...
import com.github.edwnmrtnz.poskocore.data.api.UserService
import com.github.edwnmrtnz.poskocore.data.deserializer.UserDeserializer
...
class UserRemoteDataSource(private val retrofitHelper: RetrofitHelper, private val gsonBuilder : GsonBuilder) {
    private val BASE_URL = "http://192.168.1.106:3000"

    fun authenticateUser(account_name: String, email: String, password: String, callback: UserDataSource.AuthenticateUserCallback) {
